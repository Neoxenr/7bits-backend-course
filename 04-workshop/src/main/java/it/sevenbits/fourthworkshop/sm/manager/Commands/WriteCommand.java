...
public class WriteCommand implements INetworkManagerCommand {
     ...
     */
    public WriteCommand(final StringBuilder buffer, final NetworkPackage networkPackage) {
        this.buffer = buffer;
     ...
     */
    public void execute() {
        System.out.println("MESSAGE ADDED: " + networkPackage.getMessage());
        buffer.append(networkPackage.getMessage());
    }
}
